...
AIRPORT_LATITUDE			INT(12) NOT NULL,
AIRPORT_LONGITUDE			INT(12) NOT NULL,
...
('SJC','ONT','2015-12-26 07:30:00','2015-12-26 08:40:00','5897','Nonstop','120','6862','Wanna Get Away','2015-12-01 10:30:00'),
('ONT','SJC','2015-12-29 06:10:00','2015-12-29 07:25:00','3117','Nonstop','65','3476','Wanna Get Away','2015-12-01 10:30:00');

INSERT INTO RESERVED_FLIGHTS (CONFIRMATION_NUM,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUM,WIRELESS_CARRIER_ID,UPCOMING_FLIGHT_ID,FARE_LABEL,FARE_PRICE_PAID,FARE_TYPE,UPDATE_TIMESTAMP) VALUES 
('RTG7KW','DANIELLE','GONZALEZ','NULL','9095698490','2','100000','DOLLARS','100','Wanna Get Away','2015-12-01 10:30:00'),
('RTG7KW','DANIELLE','GONZALEZ','NULL','9095698490','2','100001','DOLLARS','65','Wanna Get Away','2015-12-01 10:30:00');
