...
$DEPART_DATE_TIME_1 =	$_POST['DEPART_DATE_TIME_1'];
$ARRIVE_DATE_TIME_1 =	$_POST['ARRIVE_DATE_TIME_1'];
$DEPART_AIRPORT_CODE_1 =$_POST['DEPART_AIRPORT_CODE_1'];
$ARRIVE_AIRPORT_CODE_1 =$_POST['ARRIVE_AIRPORT_CODE_1'];
...
$DEPART_DATE_TIME_2 =	$_POST['DEPART_DATE_TIME_2'];
$ARRIVE_DATE_TIME_2 =	$_POST['ARRIVE_DATE_TIME_2'];
$DEPART_AIRPORT_CODE_2 =$_POST['DEPART_AIRPORT_CODE_2'];
$ARRIVE_AIRPORT_CODE_2 =$_POST['ARRIVE_AIRPORT_CODE_2'];
...
if(isset($DEPART_DATE_1) && isset($DEPART_DATE_2)) {
	$sql = "INSERT INTO RESERVED_FLIGHTS (CONFIRMATION_NUM,FIRST_NAME,LAST_NAME,EMAIL,DEPART_AIRPORT_CODE,ARRIVE_AIRPORT_CODE,DEPART_DATE,DEPART_TIME,ARRIVE_TIME,FLIGHT_NUM,FARE_LABEL,FARE_PRICE,FARE_TYPE) VALUES 
	('".$CONFIRMATION_NUM."','".$FIRST_NAME."','".$LAST_NAME."','".$EMAIL."','".$DEPART_AIRPORT_CODE_1."','".$ARRIVE_AIRPORT_CODE_1."','".$DEPART_DATE_1."','".$DEPART_DATE_TIME_1."','".$ARRIVE_DATE_TIME_1."','".$FLIGHT_NUM_1."','".$FARE_LABEL_1."','".$FARE_PRICE_1."','".$FARE_TYPE_1."'),
	('".$CONFIRMATION_NUM."','".$FIRST_NAME."','".$LAST_NAME."','".$EMAIL."','".$DEPART_AIRPORT_CODE_2."','".$ARRIVE_AIRPORT_CODE_2."','".$DEPART_DATE_2."','".$DEPART_DATE_TIME_2."','".$ARRIVE_DATE_TIME_2."','".$FLIGHT_NUM_2."','".$FARE_LABEL_2."','".$FARE_PRICE_2."','".$FARE_TYPE_2."')";
...
if ($res = $db->query($sql)) {
	if ($res->fetchColumn() > 0) {
		$flightCount = 0;
		$sql = "SELECT UF.*,A.AIRPORT_NAME as DEPART_AIRPORT_NAME,B.AIRPORT_NAME as ARRIVE_AIRPORT_NAME FROM RESERVED_FLIGHTS AS UF LEFT JOIN AIRPORTS as A ON A.AIRPORT_CODE=UF.DEPART_AIRPORT_CODE LEFT JOIN AIRPORTS as B ON B.AIRPORT_CODE=UF.ARRIVE_AIRPORT_CODE WHERE UF.CONFIRMATION_NUM='".$CONFIRMATION_NUM."' AND UF.FIRST_NAME='".$FIRST_NAME."' AND UF.LAST_NAME='".$LAST_NAME."' ORDER BY UF.DEPART_DATE ASC";
		foreach ($db->query($sql) as $row) {
			$flightCount++;
			if($flightCount == 1) {
