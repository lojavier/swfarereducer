...
if(isset($UPCOMING_FLIGHT_ID_1) && isset($UPCOMING_FLIGHT_ID_2)) {
	$sql = "DELETE FROM RESERVED_FLIGHTS WHERE UPCOMING_FLIGHT_ID IN (".$UPCOMING_FLIGHT_ID_1.",".$UPCOMING_FLIGHT_ID_2.")";
} elseif(isset($UPCOMING_FLIGHT_ID_1) && !isset($UPCOMING_FLIGHT_ID_2)) {
	$sql = "DELETE FROM RESERVED_FLIGHTS WHERE UPCOMING_FLIGHT_ID=".$UPCOMING_FLIGHT_ID_1;
}
try {
	$stmt = $db->prepare($sql);
    $stmt->execute();
