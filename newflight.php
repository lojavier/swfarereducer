...
$command = "/usr/bin/wget --save-cookies=cookie --post-data='confirmationNumber=8ABYGC&firstName=LORENZO&lastName=JAVIER&submit=submit' https://www.southwest.com/flight/change-air-reservation.html 2>&1";
$output = shell_exec($command);
echo $output;
